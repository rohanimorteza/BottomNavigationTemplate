...
public class DetailActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stdimg = findViewById(R.id.img_student);
        student = new Student();
        name = findViewById(R.id.txt_detail_name);
        edu = findViewById(R.id.txt_detail_edu);
        ...
        //Toast.makeText(getApplicationContext(),b.get("ID").toString(),Toast.LENGTH_LONG).show();

        dbHandler dbh = new dbHandler(this);
        dbh.open();
        student = dbh.displayStudent(b.get("ID").toString());
        dbh.close();
